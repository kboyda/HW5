...
Partial Class _Default
    ...
    Protected Sub btnCalcPmt_Click(sender As Object, e As EventArgs) Handles btn_Calculate.Click
        ...
        annualRate = CDbl(tb_annInterest.Text)
        term = CDbl(tb_loanTerms.Text)
        ...
        lbl_total.Text = ("Monthly Payment: " & FormatCurrency(monthlyPayment))
        ...
        For counterStart = 1 To loanTerm
            ...
            tRow("New Balance") = String.Format("{0:C}", loanAmount)
